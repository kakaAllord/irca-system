...
/**
 * Counts every request against the church it was for: how many, how many
 * failed, and how long they took. This is what the dev console shows, and
 * what tells the owner which church is using what.
 */
@Injectable()
