...
export const UI = {
  ...
  saved: T(
    ...
    'Imehifadhiwa · unaweza kurudi',
    'Enregistré · vous pouvez revenir',
  ),
  ...
  ePhone: T(
    'A working phone number is needed',
    'Namba sahihi ya simu inahitajika',
  ...
  pickAny: T(
    ...
    'Chagua zote zinazokuhusu',
    'Choisissez tout ce qui vous concerne',
  ),
  ...
  phCountry: T(
    'e.g. Kenya, Rwanda, France',
    'mfano Kenya, Rwanda, Ufaransa',
    'ex. Kenya, Rwanda, France',
  ),
  lblStay: T(
    'How long are you in Arusha?',
    'Utakaa Arusha muda gani?',
    'Combien de temps à Arusha ?',
  ),
  lblOften: T(
    'How often do you come to Arusha?',
    'Unakuja Arusha mara ngapi?',
  ...
  // Date wheel
  dobTrigger: T(
    'Tap to set your date of birth',
    'Bonyeza kuweka tarehe ya kuzaliwa',
    'Touchez pour indiquer votre date de naissance',
  ),
  ...
  phMinistry: T(
    'Something else? e.g. Counselling, Finance',
    'Nyingine? mfano Ushauri, Fedha',
    'Autre ? ex. Conseil, Finances',
  ),
  ...
  qBapt: T(
    ...
    'Je umebatizwa kwa maji mengi?',
    'Avez-vous été baptisé par immersion ?',
  ),
  qHoly: T(
    'Have you been filled with the Holy Spirit?',
    'Je umejazwa na Roho Mtakatifu?',
    'Avez-vous été rempli du Saint-Esprit ?',
  ),
  qPrev: T(
    'Were you worshipping at another church before?',
    'Ulikuwa ukiabudu kanisa lingine kabla?',
    'Fréquentiez-vous une autre église ?',
  ),
  lblWantMore: T(
  ...
  lblMarriedYear: T(
    'Which year were you married?',
    'Mlifunga ndoa mwaka gani?',
    'Année du mariage ?',
  ),
  ...
  workHint: T(
    ...
    'Unaweza kuandika zaidi ya moja.',
  ...
  phWork: T(
    'e.g. Teacher, Nurse, Tailor, Farmer',
    'mfano Mwalimu, Muuguzi, Fundi cherehani',
    'ex. Enseignant, Infirmier, Couturier',
  ),

  lblLiked: T(
    'What did you like about our service today?',
    'Ulipenda nini katika ibada yetu ya leo?',
    "Qu'avez-vous aimé dans notre culte aujourd'hui ?",
  ),
  likedHint: T(
    'It helps us serve better next Sunday.',
    'Inatusaidia kuhudumu vizuri Jumapili ijayo.',
    'Cela nous aide pour dimanche prochain.',
  ),
...
export type Values = {
  ...
  baptYear: string;
  holy: boolean | null;
  prevChurch: boolean | null;
  prevChurchName: string;
  marital: string;
  marriedYear: string;
  kids: boolean | null;
  children: string[];
...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    opts: [
      {
        val: 'A friend',
        label: T('A friend invited me', 'Rafiki alinialika', "Un ami m'a invité"),
      },
    ...
    groups: [
      {
        ...
        label: T(
          ...
          'Ni kipi kinachoelezea ujio wako leo?',
          'Ce qui décrit votre visite ?',
        ),
        other: 'visitOtherText',
        otherPh: T('Tell us in your own words', 'Andika kwa maneno yako', 'Dites-le avec vos mots'),
        opts: [
          {
            val: 'First time visitor',
            label: T('First time visitor', 'Mgeni wa mara ya kwanza', 'Première visite'),
          },
          {
            val: 'Just greeting',
            label: T('Visiting or greeting', 'Natembelea au kusalimu', 'En visite ou pour saluer'),
          },
          {
            val: 'Passing through',
            label: T('Traveler or passing through', 'Msafiri au napita tu', 'De passage'),
          },
      ...
      },
      {
        ...
        single: true,
        label: T(
          'Do you live here in Arusha?',
          'Je unaishi hapa Arusha?',
          'Habitez-vous ici à Arusha ?',
        ),
        opts: [
  ...
  },
  {
    ...
    ph: T(
      ...
      'Andika ombi lako hapa…',
      'Écrivez votre demande ici…',
    ),
    note: T(
      'Only the pastoral team reads prayer requests.',
      'Timu ya uchungaji pekee inasoma maombi haya.',
      "Seule l'équipe pastorale lit les demandes.",
    ),
    ...
    groups: [
      {
        ...
        opts: [
          {
            val: 'Salvation',
            label: T('Give my life to Christ', 'Kumpokea Kristo', 'Donner ma vie au Christ'),
          },
          ...
          {
            val: 'Renewing my commitment',
            label: T('Renew my vows', 'Kuhuisha ahadi', 'Renouveler mes vœux'),
          },
          { val: 'Serving', label: T('Serve somewhere', 'Kuhudumu', 'Servir') },
          {
            val: 'Nothing for now',
            label: T('Nothing for now', 'Hakuna kwa sasa', 'Rien pour le moment'),
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    sub: T(
      'Answer what you can. There is no wrong answer here.',
      'Jibu unavyoweza. Hakuna jibu baya hapa.',
      'Répondez ce que vous pouvez. Aucune mauvaise réponse.',
    ),
  ...
  },
  {
    ...
    sub: T(
      ...
      'Chagua zozote. Unaweza kubadilisha baadaye.',
      'Choisissez librement. Modifiable plus tard.',
    ),
    ...
    opts: [
      ...
      {
        val: 'Ladies',
        label: T("Ladies' fellowship", 'Ushirika wa akina mama', 'Groupe des femmes'),
      },
