...
export const adminModule = defineModule({
  ...
  permissions: {
    ...
    'admin.departments.manage': {
      kind: 'write',
      label: 'Create departments, give them their portal, and name and remove their leaders',
      hint: 'Only a confirmed member can be named a leader. A leader then adds their own members.',
    },
